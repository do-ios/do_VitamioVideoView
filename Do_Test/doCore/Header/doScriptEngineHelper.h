...
+(BOOL) InvokeSyncSelector:(id) _self : (NSString*) _methodName : (NSDictionary *) _dictParas :(id<doIScriptEngine>) _scriptEngine : (doInvokeResult *)_invokeResult;
+(BOOL) InvokeASyncSelector:(id) _self :(NSString *) _methodName : (NSDictionary *) _dictParas :(id<doIScriptEngine>) _scriptEngine : (NSString *) _callbackFuncName ;
